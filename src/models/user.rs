...
impl User {
    pub fn new(allow_avatar_copying: bool, bio: std::sync::Arc<str>, bio_links: Vec<std::sync::Arc<str>>, current_avatar_image_url: std::sync::Arc<str>, current_avatar_thumbnail_image_url: std::sync::Arc<str>, current_avatar_tags: Vec<crate::models::tags::Tags>, date_joined: std::sync::Arc<str>, developer_type: models::DeveloperType, display_name: std::sync::Arc<str>, friend_key: std::sync::Arc<str>, id: std::sync::Arc<str>, is_friend: bool, last_activity: std::sync::Arc<str>, last_login: std::sync::Arc<str>, last_platform: std::sync::Arc<str>, platform: std::sync::Arc<str>, profile_pic_override: std::sync::Arc<str>, profile_pic_override_thumbnail: std::sync::Arc<str>, pronouns: std::sync::Arc<str>, state: models::UserState, status: models::UserStatus, status_description: std::sync::Arc<str>, tags: Vec<crate::models::tags::Tags>, user_icon: std::sync::Arc<str>) -> User {
        User {
