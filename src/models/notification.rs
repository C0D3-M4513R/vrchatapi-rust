...
impl Notification {
    /// 
    pub fn new(created_at: std::sync::Arc<str>, details: std::sync::Arc<str>, id: std::sync::Arc<str>, message: std::sync::Arc<str>, sender_user_id: std::sync::Arc<str>, r#type: crate::models::NotificationType) -> Notification {
        Notification {
            created_at,
            details,
            id,
