...
impl Instance {
    ...
    pub fn new(active: bool, can_request_invite: bool, capacity: i32, client_number: std::sync::Arc<str>, full: bool, id: std::sync::Arc<str>, instance_id: std::sync::Arc<str>, location: std::sync::Arc<str>, n_users: i32, name: std::sync::Arc<str>, permanent: bool, photon_region: crate::models::Region, platforms: crate::models::InstancePlatforms, region: crate::models::InstanceRegion, secure_name: std::sync::Arc<str>, tags: Vec<crate::models::tags::Tags>, r#type: crate::models::InstanceType, world_id: std::sync::Arc<str>, queue_enabled: bool, queue_size: i32, recommended_capacity: i32, strict: bool, user_count: i32, world: crate::models::World) -> Instance {
        Instance {
            active,
            can_request_invite,
            capacity,
